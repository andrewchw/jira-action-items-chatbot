...
chrome.notifications.onButtonClicked.addListener(function (notificationId, buttonIndex) {
  console.log("Notification ".concat(notificationId, " button ").concat(buttonIndex, " clicked"));
  // Implement actions based on which button was clicked
});

// API request handling
function handleApiRequest(_x) {
  return _handleApiRequest.apply(this, arguments);
} // Get server URL from storage
function _handleApiRequest() {
  _handleApiRequest = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(endpoint) {
    var method,
      data,
      serverUrl,
      url,
...
function _getServerUrl() {
  _getServerUrl = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
